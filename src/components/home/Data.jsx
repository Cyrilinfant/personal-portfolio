...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Cyril A
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Hello! I'm Cyril, a Full Stack Developer with a passion for building efficient, scalable, and user-friendly web applications. With a strong background in both frontend and backend.</p>
